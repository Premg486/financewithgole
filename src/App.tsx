...
export function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <a
        href="tel:9029994768"
        className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-primary-600 hover:bg-primary-700 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 md:hidden"
        aria-label="Call Now"
      >
